/**
 * Khattak Hotel - PWA Install Handler
...
(function() {
    ...
    function checkIfInstalled() {
        ...
        // (prevents a stale install flag from blocking the banner)
    ...
    function showInstallSuccess() {
        ...
        toast.style.cssText = 'background:#D60040; box-shadow:0 4px 20px rgba(214,0,64,0.4); border:1px solid rgba(214,0,64,0.6);';
        toast.innerHTML = `
            <i class="fas fa-check-circle"></i>
            <span>Khattak Hotel installed successfully!</span>
        `;
