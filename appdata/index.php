...
// Admin password is kept out of tracked source — see api/secrets.php (gitignored)
...
if (!isset($_SESSION['appdata_auth']) || $_SESSION['appdata_auth'] !== true) {
    ...
    <head>
        ...
        <title>Admin Access | Khattak Hotel</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PWA Install Stats | Khattak Hotel Admin</title>
    <meta name="robots" content="noindex, nofollow">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card.highlight {
            background: linear-gradient(135deg, #D60040 0%, #9F0030 100%);
        }
        ...
        new Chart(document.getElementById('dailyChart'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: dailyCounts,
                    borderColor: '#D60040',
                    backgroundColor: 'rgba(214, 0, 64, 0.1)',
                    fill: true,
                    tension: 0.4,
