/**
 * Khattak Hotel - Service Worker
 * Handles caching for offline functionality
 */

const CACHE_NAME = 'khattak-hotel-v1';
const STATIC_CACHE = 'khattak-hotel-static-v1';
const DYNAMIC_CACHE = 'khattak-hotel-dynamic-v1';

// Files to cache immediately on install
const STATIC_ASSETS = [
    '/',
    '/manifest.json',
    '/icons/khattak-hotel-logo.png',
    '/menu-data.json'
];
